...
def main():
  ...
  while 1:
    ...
    if command == "cancel":
      ...
      ppap11="{{l_sho_and_r_sho}[x=30]_and_{r_elb_and_l_elb}[x=-40]_then_ln[x=30]}"
      ppap12 = "{ln[x=30,d=500]_then_ln[x=-30,d=500]}"#_then_{wait[x=500]_then_speak[こっち見ないでください]}"
      time.sleep(1.8)
      ppap = ppap11
